...
parser = argparse.ArgumentParser(description='Encrypt or decrypt a string encrypted with AES-128-CTR')
...
parser.add_argument("-n", "--nonce", help="nonce", action="store")
...
result=bytearray(CTR(bcontent, expandedkey, args.nonce))
